      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
            <a class="nav-link" href="dashboardStudent.php">
              <i class="fa fa-fw fa-dashboard"></i>
              <span class="nav-link-text">
                Dashboard</span>
            </a>
          </li>
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Assignment">
            <a class="nav-link" href="assignmentStudent.php">
          ...
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Marks">
            <a class="nav-link" href="marksStudent.php">
